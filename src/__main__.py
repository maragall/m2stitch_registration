...
from m2stitch.tile_registration import register_tiles
from m2stitch.tile_registration import register_and_update_coordinates
...
@click.option('--ncc-threshold', default=0.1, type=float,
